...
function(){
    if(document.visibilityState === "visible"){
        document.title = "🥰 PORTAFOLIO | ELDER ADAN 🥰";
        $("#favicon").attr("href","assests/images/favicon.jpg");
    }
    else {
        document.title = "👉🏽REGRESAR A PORTAFOLIO👈🏽";
...
// <!-- typed js effect starts -->
    var typed = new Typed(".typing-text", {
        strings: ["front end developer", "Diseñador", "Programador Web", "desarrollador web"],
        loop: true,
        typeSpeed: 50,
		backSpeed: 25,
		backDelay: 500,
...
var Tawk_API=Tawk_API||{}, Tawk_LoadStart=new Date();
  ...
  s1.async=true;
  s1.src='https://embed.tawk.to/617877ccf7c0440a592022e4/1fiv97u65';
  s1.charset='UTF-8';
